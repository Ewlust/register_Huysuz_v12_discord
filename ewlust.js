...
**<@`+ member + `> Sunucumuza Hoşgeldin**
         ...
         Kayıt olabilmek için Register Area odalarından birine gir.

         Hesab Kuruluş Tarihi **`+gecen+`** 

         Hesabın kontrol durumu **`+kontrol+`**

        <@&kayıtsorumlusurolid> Seninle İlgilenecektir

        tagınızı buraya yazın Tagımızı alarak Destek Olabilirsin**
`)});
